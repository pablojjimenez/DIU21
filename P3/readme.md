...
En cuanto a la valoración de las diferentes herramientas que hemos usado. Para el diseño del Landing Page hemos hecho uso de la herramienta Figma que nos ha parecido correcta pero tal vez un poco pesada para hacer el diseño de un único boceto. Para el diseño del Mockup hemos hecho uso de Bootstrap que nos ha parecido una herramienta bastante dificil de manejar al principio pero con la ractica se hace más sencillo y además los resultados son excelentes pues pedes ir viendo como se va formando la página web y la conexión del mapsite.
